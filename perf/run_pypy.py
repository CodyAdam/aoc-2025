...
def uses_z3(script_code):
    """Check if script uses z3-solver (not compatible with PyPy)."""
    return "from z3 import" in script_code or "import z3" in script_code
...
def run_script(script_path):
    ...
    try:
        ...
        # Skip scripts that use z3-solver (not compatible with PyPy)
        if uses_z3(script_code):
            return None, "Skipped"
